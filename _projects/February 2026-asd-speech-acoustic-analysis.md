...
date: February 2026
permalink: "/projects/asd-speech-acoustic-analysis/"
...
image: "/assets/images/projects/asd-speech-acoustic-analysis/cover.jpg"
thumbnail: "/assets/images/projects/asd-speech-acoustic-analysis/cover.jpg"
---

<img src="{{ '/assets/images/projects/asd-speech-acoustic-analysis/cover.jpg' | relative_url }}" alt="Project Cover" style="width: 250px; height: auto; display: block; margin: 0 auto 2rem auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin-bottom: 2rem; text-align: center;">
  <div>
    <img src="{{ '/assets/images/projects/asd-speech-acoustic-analysis/clinical_feature_comparison.jpg' | relative_url }}" alt="Diagram" style="width: 100%; border-radius: 6px; border: 1px solid #ddd; margin-bottom: 5px;">
  ...
  <div>
    <img src="{{ '/assets/images/projects/asd-speech-acoustic-analysis/feature_comparison_boxplot.jpg' | relative_url }}" alt="Diagram" style="width: 100%; border-radius: 6px; border: 1px solid #ddd; margin-bottom: 5px;">
